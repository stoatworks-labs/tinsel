# Running unsigned Tinsel builds
...
```sh
xattr -dr com.apple.quarantine "$HOME/Documents/Resolume Arena/Extra Effects/Tinsel.bundle"
```
...
```sh
codesign --force --deep --sign - "$HOME/Documents/Resolume Arena/Extra Effects/Tinsel.bundle"
```

Verify it took:

```sh
codesign -dv --verbose=4 "$HOME/Documents/Resolume Arena/Extra Effects/Tinsel.bundle"
spctl -a -vv "$HOME/Documents/Resolume Arena/Extra Effects/Tinsel.bundle"   # still reports "rejected" — ad-hoc is not notarization
```
