...
**[v1.0.5](https://github.com/stoatworks-labs/tinsel/releases/tag/v1.0.5)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`tinsel-1.0.5-macos-universal.dmg`](https://github.com/stoatworks-labs/tinsel/releases/download/v1.0.5/tinsel-1.0.5-macos-universal.dmg) | 256 KB |
| Universal (Apple Silicon + Intel) · .zip archive | [`tinsel-macos-universal.zip`](https://github.com/stoatworks-labs/tinsel/releases/latest/download/tinsel-macos-universal.zip) | 216 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`tinsel-1.0.5-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/tinsel/releases/download/v1.0.5/tinsel-1.0.5-windows-x86_64-setup.exe) | 234 KB |
