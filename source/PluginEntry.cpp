/**
    ...
    `CFFGLPluginInfo` that Tinsel.cpp registers at static-initialisation time.
    ...
    binary: which build it is.
        ...
        strings Tinsel.bundle/Contents/MacOS/Tinsel | grep tinsel
*/

extern "C" const char* TinselBuildStamp()
{
	return "tinsel " TINSEL_VERSION " built " __DATE__ " " __TIME__;
}
