...
# C++ name -> JavaScript name. kLightPreamble/kEffectLibrarySource/kLightMain are
# the three pieces LightShaderSource() concatenates; the demo concatenates the
# same three in the same order, so they are checked individually rather than as
# one assembled string.
PASSES = {
    "kVertexShader": "VERTEX_SHADER",
    "kCopyShader": "COPY_SHADER",
    "kEdgeShader": "EDGE_SHADER",
    "kStabiliseShader": "STABILISE_SHADER",
    "kLightPreamble": "LIGHT_PREAMBLE",
    "kEffectLibrarySource": "EFFECT_LIBRARY",
    "kLightMain": "LIGHT_MAIN",
    "kBlurShader": "BLUR_SHADER",
    "kCompositeShader": "COMPOSITE_SHADER",
}
